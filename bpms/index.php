    ...
    <section class="slide slide-one">
      <div class="container">
        <div class="banner-text">
          <h4>Glamour Girls</h4>
          <h3>Beauty parlour for woman</h3>
            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 color-2 ">
                            <div>
                            <h4 class=" ">Our Beauty Parlour is Most Popular in Kathmandu</h4>
                            <p class="para "></p>
        ...
        <div class="container">
            <div class=" row">
                ...
                <div class="col-lg-6 about-right-faq align-self">
                    <h3 class="title-big"><a href="about.html">Clean and Recommended Beauty Parlour</a></h3>
                    <p class="mt-3 para"> Our beauty parlour services include haircuts, hair spas, colouring, texturing, styling, waxing, pedicures, manicures, threading, body spa, natural facials and more.</p>
                        <div class="hair-cut">
                            <div >
...
<section class="packages">
  ...
  <div class="package-container">
    ...
    <!-- Hair Care -->
    <a href="hair-care.php" class="package-card">
      <h3>Hair Care</h3>
    </a>

    <!-- Skin Care -->
    <a href="skin-care.php" class="package-card">
      <h3>Skin Care</h3>
    </a>

    <!-- Manicure -->
    <a href="book-service.php?service=Manicure" class="package-card">
      <h3>Manicure</h3>
    </a>

    <!-- Pedicure -->
    <a href="book-service.php?service=Pedicure" class="package-card">
      <h3>Pedicure</h3>
    </a>

    <!-- Nail Care Packages -->
    <a href="nail-care.php" class="package-card">
      <h3>Nail Care</h3>
    </a>

    <!-- Wedding Packages -->
    <a href="wedding-package.php" class="package-card">
